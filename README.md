...
This is an overview of my core competencies.
...
| **Backend** | Java, Python (Flask), Flask, PyTorch |
| **Databases** | Oracle, MongoDB, PostgreSQL |
| **Design/UX** | UX/UI basics, wireframing, user-centered layouts |

### **Development Practices**

* **Version Control:** Git, GitHub/GitLab/Bitbucket
* **Testing:** Jest, React Testing Library, Cypress, Unit/Integration/E2E Testing
* **Methodology:** Agile (Scrum/Kanban), TDD (Test-Driven Development)
* **Deployment:** Docker, AWS (S3, EC2), Netlify, Vercel
